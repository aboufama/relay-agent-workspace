...
export const LiveComposer=React.forwardRef<ComposerHandle,Props>(function LiveComposer({value,onChange,onSend,members,onMention,placeholder},forwardedRef){
